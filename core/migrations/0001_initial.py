    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userType', models.CharField(choices=[('AD', 'Administrador'), ('DC', 'Docente'), ('BC', 'Becario')], default='AD', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('branch', models.CharField(choices=[('VA', 'Varonil'), ('FE', 'Femenil')], default='VA', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mail', models.EmailField(max_length=254)),
                ('totalAssists', models.SmallIntegerField(blank=True, null=True)),
                ('idTeam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Team')),
            ],
        ),
        migrations.CreateModel(
            name='Player',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('idMatch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Match')),
                ('idTeamMember', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.TeamMember')),
            ],
        ),
        migrations.AddField(
            model_name='match',
