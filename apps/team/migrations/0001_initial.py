    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rival', models.CharField(choices=[('FBA', 'Bellas Artes'), ('FCP', 'Ciencias Políticas y Sociales'), ('FCA', 'Contaduría y Administración'), ('FDE', 'Derecho'), ('FEN', 'Enfermería'), ('FFI', 'Filosofía'), ('FIN', 'Ingeniería'), ('FLL', 'Lenguas y Letras'), ('FME', 'Medicina'), ('FPS', 'Psicología'), ('FQU', 'Química')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idSesion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='get_sesion', to='team.Sesion')),
                ('idTeamMember', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='get_attendances', to='team.TeamMember')),
            ],
            options={
