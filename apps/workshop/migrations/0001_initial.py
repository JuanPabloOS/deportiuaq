# Generated by Django 2.2.5 on 2019-11-14 16:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idSesion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='get_sesion', to='workshop.Sesion')),
                ('idWsMember', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='get_attendances', to='workshop.WsMember')),
            ],
            options={
